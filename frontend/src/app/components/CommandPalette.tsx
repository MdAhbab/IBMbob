                ...
                <div key={g} className="mb-1">
                  ...
                  {items.map((c) => (
                    <button
                      ...
                      className="flex w-full items-center gap-2.5 rounded-md px-2 py-2 text-left text-[13px] text-zinc-800 transition hover:bg-zinc-100 dark:text-zinc-200 dark:hover:bg-white/[0.05]"
                    >
