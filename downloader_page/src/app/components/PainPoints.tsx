  ...
  return (
    <section id="problem" className="relative py-32 px-4">
      ...
      <div className="max-w-6xl mx-auto">
        ...
        >
          <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-red-500/10 border border-red-500/20 text-sm text-red-300 mb-6">
        ...
        <div className="grid md:grid-cols-2 gap-5">
          ...
          >
            ...
            <div className="relative">
              ...
              {/* Mock terminal */}
              <div className="mt-6 rounded-xl border border-white/5 bg-black/60 p-4 font-mono text-sm space-y-1.5">
            ...
            <div className="relative">
              ...
              <div className="mt-6 rounded-xl border border-white/5 bg-black/60 p-4 space-y-3">
                {[
                  ...
                  <div key={row.name} className="flex items-center gap-3 text-sm font-mono">
        ...
        >
          {[
            ...
            <div key={s.label} className="bg-black p-6 text-center">
              ...
              <div className="mt-1 text-base text-neutral-500">{s.label}</div>
            </div>
          ))}
        </motion.div>
      </div>
