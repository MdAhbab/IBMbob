  ...
  return (
    <section className="relative min-h-screen flex flex-col items-center justify-center pt-32 pb-20 px-4 overflow-hidden">
      ...
      <motion.div
        ...
        className="mb-8 inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-white/5 border border-white/10 backdrop-blur-md text-sm text-neutral-300"
      >
      ...
      <motion.p
        ...
        className="mt-7 max-w-2xl mx-auto text-center text-neutral-400 text-xl leading-relaxed"
      >
      ...
      <motion.div
        ...
        className="mt-10 flex flex-col sm:flex-row items-stretch sm:items-center justify-center gap-3 w-full max-w-md sm:max-w-none mx-auto px-4 sm:px-0"
      >
        <a
          href="#download"
        ...
        >
          ...
          <span className="hidden lg:inline text-neutral-500 text-base ml-1">— macOS · Linux · Win</span>
        </a>
      ...
      >
        <p className="text-sm uppercase tracking-[0.2em] text-neutral-600 text-center">
          ...
          {cliLogos.map((cli, i) => (
            ...
            >
              <div className="flex items-center gap-2">
                ...
                <span className="text-base text-neutral-400 group-hover:text-neutral-200 transition-colors">
                  {cli.name}
                </span>
              </div>
            </motion.div>
      ...
      >
        ...
        <div className="rounded-2xl border border-white/10 bg-gradient-to-b from-neutral-900/80 to-black/80 backdrop-blur-xl overflow-hidden shadow-2xl">
          ...
          <div className="flex items-center justify-between px-4 py-3 border-b border-white/5 bg-black/40">
            ...
            <div className="text-sm text-neutral-500 font-mono">orchestrator · dashboard</div>
            <div className="w-12" />
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-px bg-white/5 overflow-hidden">
            {[
              ...
              <div key={stat.label} className="bg-black/60 p-4 sm:p-5">
                <div className="flex items-center gap-2 text-sm text-neutral-500 uppercase tracking-wider flex-wrap">
          ...
          <div className="p-4 sm:p-5 space-y-2 font-mono text-sm overflow-x-auto">
            {[
              ...
              <div key={row.cli} className="flex items-center justify-between gap-2 sm:gap-4 px-3 py-2 rounded-lg bg-white/[0.02] border border-white/5 min-w-[280px] sm:min-w-0">
                <div className="flex items-center gap-2 sm:gap-3 min-w-0 flex-1">
                  ...
                  <span className="text-neutral-300 truncate text-sm sm:text-base">{row.cli}</span>
                </div>
                <div className="flex items-center gap-2 sm:gap-3 flex-shrink-0">
                  <span className="text-neutral-500 hidden md:inline text-sm">{row.status}</span>
                  <span className="text-neutral-400 tabular-nums text-sm sm:text-base whitespace-nowrap">{row.pct}</span>
                </div>
              </div>
            ))}
          </div>
