  ...
  return (
    <section id="features" className="relative py-32 px-4">
      ...
      <div className="max-w-6xl mx-auto">
        ...
        >
          <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-violet-500/10 border border-violet-500/20 text-sm text-violet-300 mb-6">
          ...
          <p className="mt-5 text-neutral-400 text-xl">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-6 gap-4 auto-rows-[minmax(180px,auto)]">
          ...
          <BentoCard className="sm:col-span-2 md:col-span-2 md:row-span-2" delay={0.1}>
            ...
            <div className="relative h-full flex flex-col">
              ...
              <p className="mt-2 text-neutral-400 text-base leading-relaxed">
                ...
                <code className="px-1 py-0.5 rounded bg-white/5 text-violet-300 text-sm">skill.md</code> and{" "}
                <code className="px-1 py-0.5 rounded bg-white/5 text-violet-300 text-sm">plan.md</code>.
              ...
              <div className="mt-auto pt-6 space-y-2">
                {["claude", "gemini", "codex", "copilot", "cline"].map((cli, i) => (
                  <motion.div
                    ...
                    className="flex items-center gap-2 text-sm font-mono text-neutral-500"
                  >
          ...
          <BentoCard className="sm:col-span-1 md:col-span-3" delay={0.15}>
            ...
            <div className="relative">
              ...
              <div className="mt-4 flex flex-wrap gap-2 text-sm font-mono">
                {[
          ...
          <BentoCard className="sm:col-span-1 md:col-span-3" delay={0.2}>
            ...
            <div className="relative">
              ...
              <div className="mt-4 rounded-lg border border-white/5 bg-black/50 p-3 font-mono text-sm">
