  ...
  return (
    <div className="relative flex h-full w-full items-center justify-center overflow-hidden bg-[#fafafa] dark:bg-[#070709]">
      ...
      <div className="relative z-10 w-full max-w-3xl px-6">
        <div className="mb-6 flex items-center justify-between">
          <div className="flex items-center gap-2.5">
            ...
            <div className="leading-tight">
              <div className="bg-gradient-to-r from-indigo-400 via-violet-400 to-fuchsia-400 bg-clip-text text-[17px] tracking-tight text-transparent">
                Orchestrator
              </div>
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              onClick={finish}
              className="rounded-lg border border-zinc-200/70 bg-white px-3 py-1.5 text-[14px] text-zinc-600 hover:bg-zinc-50 dark:border-white/[0.07] dark:bg-white/[0.02] dark:text-zinc-300"
            >
              Skip setup
            </button>
          </div>
        ...
        <div className="mt-3 text-center font-mono text-[13px] text-zinc-400">
...
function StepWelcome({
  ...
  return (
    <div className="px-8 py-10">
      <div className="flex items-center gap-2 font-mono text-[13px] uppercase tracking-[0.22em] text-indigo-500">
        <Rocket className="h-3 w-3" />
        Welcome
      </div>
      <h1 className="mt-3 text-[37px] leading-[1.05] tracking-[-0.03em] text-zinc-900 dark:text-white">
        Let's orchestrate every AI <br className="hidden md:block" />
        CLI you use.
      </h1>
      <p className="mt-3 max-w-md text-[16.5px] leading-relaxed text-zinc-500">
      ...
      <div className="mt-6 grid grid-cols-3 gap-2">
        {[
          ...
          >
            ...
            <div className="mt-2 text-[15px] text-zinc-900 dark:text-white">{t}</div>
            <div className="font-mono text-[13px] text-zinc-500">{s}</div>
          </div>
        ))}
      </div>
      ...
      <div className="mt-6 flex items-center justify-between rounded-xl border border-zinc-200/70 bg-zinc-50/60 px-4 py-3 dark:border-white/[0.06] dark:bg-white/[0.02]">
        <div className="flex items-center gap-2">
          ...
          <span className="text-[15px] text-zinc-700 dark:text-zinc-300">
            Appearance · {theme === "dark" ? "Dark" : "Light"}
          </span>
        </div>
        <button
          onClick={toggleTheme}
          className="rounded-md border border-zinc-200/70 bg-white px-2 py-1 text-[14px] text-zinc-700 hover:bg-zinc-100 dark:border-white/[0.07] dark:bg-white/[0.02] dark:text-zinc-300"
        >
          Switch
        </button>
      </div>
...
function StepWorkspace({
  ...
  return (
    <div className="px-8 py-10">
      ...
      <h2 className="mt-3 text-[29px] leading-tight tracking-tight text-zinc-900 dark:text-white">
        Where should orchestra live?
      </h2>
      <p className="mt-2 max-w-lg text-[16px] leading-relaxed text-zinc-500">
      ...
      >
        ...
        <div className="flex-1 text-left">
          <div className="text-[16px] text-zinc-900 dark:text-white">
      ...
      <div className="mt-4">
        <div className="font-mono text-[13px] uppercase tracking-[0.2em] text-zinc-500">
          Recent
        </div>
        <div className="mt-2 space-y-1.5">
          {RECENT_FOLDERS.map((p) => (
            ...
            >
              <span className="font-mono text-[14.5px] text-zinc-700 dark:text-zinc-200">{p}</span>
      ...
      <div className="mt-4">
        <label className="font-mono text-[13px] uppercase tracking-[0.2em] text-zinc-500 dark:text-zinc-400">
          or type a path
        </label>
        <input
          value={folderPath}
          ...
          className="mt-1.5 w-full rounded-lg border border-zinc-200/70 bg-white px-3 py-2 font-mono text-[15px] text-zinc-800 outline-none focus:border-indigo-400 dark:border-white/[0.06] dark:bg-white/[0.02] dark:text-zinc-200"
        />
      </div>
            ...
            >
              ...
              <div className="min-w-0 flex-1">
                <div className="flex items-center gap-1.5">
                  <span className="text-[15.5px] text-zinc-900 dark:text-white">{p.name}</span>
                  {p.configured && (
                    <span className="rounded-md border border-emerald-300/40 bg-emerald-50 px-1 py-0.5 font-mono text-[11px] uppercase tracking-wider text-emerald-700 dark:border-emerald-400/20 dark:bg-emerald-400/[0.08] dark:text-emerald-300">
                      configured
                    </span>
                  )}
                </div>
                <div className="mt-0.5 line-clamp-2 text-[14px] text-zinc-500">
                  {p.description}
                </div>
              </div>
              <div
...
function StepSharedAccount({
  ...
  return (
    <div className="px-8 py-10">
        ...
        <div>
          ...
          <div className="mt-1.5 flex items-center gap-1.5 rounded-lg border border-zinc-200/70 bg-white px-3 dark:border-white/[0.06] dark:bg-white/[0.02]">
            ...
            <input
              ...
              className="w-full bg-transparent py-2.5 text-[16px] text-zinc-800 outline-none placeholder:text-zinc-400 dark:text-zinc-200"
            />
      ...
      <p className="mt-2 font-mono text-[12.5px] text-zinc-500">
        ...
        <div className="mt-6">
          ...
          <div className="flex flex-wrap gap-1.5">
            {accountClis.map((p) => (
              <span
                key={p.id}
                className="inline-flex items-center gap-1 rounded-md border border-zinc-200/70 bg-white px-2 py-1 text-[13.5px] text-zinc-700 dark:border-white/[0.06] dark:bg-white/[0.02] dark:text-zinc-300"
              >
                <span className={`${p.color} font-mono text-[15px] leading-none`}>
                  {p.glyph}
                </span>
                {p.name}
      ...
      {apiOnlyClis.length > 0 && (
        <div className="mt-4 rounded-lg border border-zinc-200/70 bg-zinc-50/60 px-3 py-2.5 dark:border-white/[0.06] dark:bg-white/[0.02]">
          <div className="font-mono text-[12.5px] uppercase tracking-[0.2em] text-zinc-500">
          ...
          <div className="mt-1.5 flex flex-wrap gap-1.5">
            {apiOnlyClis.map((p) => (
              <span
                key={p.id}
                className="inline-flex items-center gap-1 rounded-md border border-zinc-200/70 bg-white px-1.5 py-0.5 text-[13.5px] text-zinc-700 dark:border-white/[0.06] dark:bg-white/[0.02] dark:text-zinc-300"
              >
                <span className={`${p.color} font-mono text-[15px] leading-none`}>
                  {p.glyph}
                </span>
  ...
  return (
    <div className="px-8 py-10">
            ...
            >
              ...
              >
                ...
                <div className="min-w-0 flex-1">
                  <div className="flex items-center gap-1.5">
                    <span className="text-[15.5px] text-zinc-900 dark:text-white">{p.name}</span>
                    <span className="rounded-md border border-zinc-200/70 bg-zinc-50 px-1.5 py-0.5 font-mono text-[11.5px] uppercase tracking-wider text-zinc-500 dark:border-white/[0.06] dark:bg-white/[0.04]">
                      {c.method.replace("_", " ")}
                    </span>
                    {isValid(c) && (
      ...
      <div className="mt-8 flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          <span className="font-mono text-[13.5px] text-zinc-500">
...
function ConfigureRow({
  ...
  return (
    <div className="space-y-3">
          ...
          {provider.authMethods.map((m) => {
            ...
            return (
              <button
                ...
                className={`flex items-center justify-center gap-1.5 rounded-lg border px-2 py-2 text-[14px] transition ${
                  active
            ...
            <div className="flex items-center justify-between rounded-lg border border-indigo-300/40 bg-indigo-50/60 px-3 py-2 dark:border-indigo-400/30 dark:bg-indigo-400/[0.06]">
              <div className="flex min-w-0 items-center gap-2">
                ...
                <div className="min-w-0">
                  <div className="truncate text-[15.5px] text-zinc-900 dark:text-white">
                    {sharedEmail}
                  </div>
                  <div className="font-mono text-[12.5px] uppercase tracking-wider text-indigo-600 dark:text-indigo-300">
              ...
              <button
                ...
                className="shrink-0 rounded-md border border-zinc-200/70 bg-white px-2 py-1 text-[13.5px] text-zinc-600 hover:bg-zinc-50 dark:border-white/[0.07] dark:bg-white/[0.02] dark:text-zinc-300"
              >
                Use different
              </button>
            </div>
            ...
            <div className="grid grid-cols-1 gap-2 sm:grid-cols-2">
              <Field label={`${provider.accountProvider || provider.name} email`}>
                <div className="flex items-center gap-1.5 rounded-lg border border-zinc-200/70 bg-white px-2.5 dark:border-white/[0.06] dark:bg-white/[0.02]">
                  ...
                  <input
                    ...
                    className="w-full bg-transparent py-2 text-[15.5px] text-zinc-800 outline-none placeholder:text-zinc-400 dark:text-zinc-200"
                  />
                </div>
              </Field>
              ...
              {sharedEmail && (
                <button
                  ...
                  className="col-span-full justify-self-start rounded-md border border-zinc-200/70 bg-white px-2 py-1 text-[13.5px] text-zinc-600 hover:bg-zinc-50 dark:border-white/[0.07] dark:bg-white/[0.02] dark:text-zinc-300"
                >
      ...
      {cfg.method === "oauth" && (
        <button className="flex w-full items-center justify-center gap-2 rounded-lg border border-zinc-200/70 bg-white py-2.5 text-[15.5px] text-zinc-700 transition hover:bg-zinc-50 dark:border-white/[0.06] dark:bg-white/[0.02] dark:text-zinc-200 dark:hover:bg-white/[0.05]">
      ...
      <Field label="Default model">
        <Select value={cfg.model} onValueChange={(v) => onChange({ model: v })}>
          <SelectTrigger className="w-full font-mono text-[15.5px] dark:bg-white/[0.02] dark:border-white/[0.06] dark:text-zinc-200">
            <SelectValue />
          </SelectTrigger>
          <SelectContent className="font-mono text-[15.5px]">
...
function StepReview({
  ...
  return (
    <div className="px-8 py-10">
      <div className="flex items-center gap-2 font-mono text-[13px] uppercase tracking-[0.22em] text-emerald-600 dark:text-emerald-400">
        <CheckCircle2 className="h-3 w-3" /> Ready
      </div>
      <h2 className="mt-3 text-[31px] leading-tight tracking-tight text-zinc-900 dark:text-white">
        You're all set.
      </h2>
      <p className="mt-2 max-w-lg text-[16px] text-zinc-500">
      ...
      <div className="mt-6 space-y-3">
        <div className="rounded-xl border border-zinc-200/70 bg-zinc-50/60 px-4 py-3 dark:border-white/[0.06] dark:bg-white/[0.02]">
          ...
          <div className="mt-1 font-mono text-[15.5px] text-zinc-900 dark:text-white">
            {workspace}
          </div>
        </div>
          ...
          <div className="mt-2 space-y-1.5">
            {enabled.map((p) => {
              ...
              return (
                <div
                  key={p.id}
                  className="flex items-center gap-2 rounded-md border border-zinc-200/70 bg-white px-2 py-1.5 text-[14.5px] dark:border-white/[0.06] dark:bg-white/[0.02]"
                >
                  ...
                  <span className="ml-auto truncate font-mono text-[12.5px] text-zinc-500">
                    {summary}
                  </span>
                </div>
              );
...
const inputCls =
  "w-full rounded-lg border border-zinc-200/70 bg-white px-3 py-2 text-[15.5px] text-zinc-800 outline-none focus:border-indigo-400 dark:border-white/[0.06] dark:bg-white/[0.02] dark:text-zinc-200";

function Field({ label, children }: { label: string; children: React.ReactNode }) {
  return (
    <div>
      <label className="mb-1 block font-mono text-[13px] uppercase tracking-[0.2em] text-zinc-500 dark:text-zinc-400">
        {label}
      </label>
      {children}
    </div>
...
function PrimaryBtn({
  ...
  return (
    <button
      onClick={onClick}
      disabled={disabled}
      className="flex items-center gap-1.5 rounded-lg bg-zinc-900 px-3.5 py-2 text-[15.5px] text-white shadow-sm transition hover:bg-zinc-800 disabled:opacity-40 dark:bg-white dark:text-zinc-900 dark:hover:bg-zinc-200"
    >
      {children}
    </button>
  );
...
function GhostBtn({ children, onClick }: { children: React.ReactNode; onClick: () => void }) {
  return (
    <button
      onClick={onClick}
      className="flex items-center gap-1.5 rounded-lg border border-zinc-200/70 bg-white px-3 py-2 text-[15px] text-zinc-700 hover:bg-zinc-50 dark:border-white/[0.07] dark:bg-white/[0.02] dark:text-zinc-300 dark:hover:bg-white/[0.05]"
    >
      {children}
    </button>
  );
