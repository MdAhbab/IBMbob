  ...
  return (
    <div className="group flex cursor-pointer items-start gap-2 rounded-md border border-transparent px-2 py-1.5 transition hover:border-zinc-200/70 hover:bg-white dark:hover:border-white/[0.06] dark:hover:bg-white/[0.03]">
      ...
      <div className="min-w-0 flex-1">
        <div className="truncate text-[14.5px] leading-snug text-zinc-800 dark:text-zinc-200">
          {s.prompt}
        </div>
        <div className="mt-0.5 flex items-center gap-1.5 font-mono text-[12px] text-zinc-500">
  ...
  const content = (
    <>
      <div className="flex items-center gap-2.5 border-b border-zinc-200/70 px-4 py-4 dark:border-white/[0.06]">
        ...
        <span className="flex-1 bg-gradient-to-r from-indigo-400 via-violet-400 to-fuchsia-400 bg-clip-text text-[17px] leading-none tracking-tight text-transparent">
          Orchestrator
        </span>
        <button
      ...
      <div className="border-b border-zinc-200/70 px-3 py-3 dark:border-white/[0.06]">
        <div className="flex items-center justify-between">
          <span className="flex items-center gap-1.5 font-mono text-[12px] uppercase tracking-[0.2em] text-zinc-500 dark:text-zinc-400">
        ...
        <div className="mt-2.5 flex items-center gap-1.5 rounded-md border border-zinc-200/70 bg-white px-2 dark:border-white/[0.06] dark:bg-black/30">
          ...
          <input
            ...
            className="w-full bg-transparent py-1.5 text-[14.5px] text-zinc-800 outline-none placeholder:text-zinc-400 dark:text-zinc-200"
          />
        </div>
      </div>
        ...
        <div className="overflow-hidden rounded-lg border border-zinc-200/70 bg-white/40 dark:border-white/[0.07] dark:bg-white/[0.015]">
          ...
          >
            <div className="flex items-center gap-2">
              <span className="bg-gradient-to-r from-indigo-400 to-fuchsia-400 bg-clip-text font-mono text-[13.5px] uppercase tracking-[0.22em] text-transparent">
                Recent Sessions
              </span>
              <span className="rounded-md border border-zinc-200/70 bg-white px-1.5 py-0.5 font-mono text-[12px] text-zinc-600 dark:border-white/[0.08] dark:bg-white/[0.04] dark:text-zinc-300">
                {filtered.length}
              </span>
            </div>
            <ChevronDown
        ...
        <div className="overflow-hidden rounded-lg border border-zinc-200/70 bg-white/40 dark:border-white/[0.07] dark:bg-white/[0.015]">
          ...
          >
            <div className="flex items-center gap-2">
              ...
              <span className="rounded-md border border-emerald-300/40 bg-emerald-50 px-1.5 py-0.5 font-mono text-[12px] text-emerald-700 dark:border-emerald-400/20 dark:bg-emerald-400/10 dark:text-emerald-300">
                clean
              </span>
            </div>
            <ChevronDown
                ...
                <div className="space-y-2 border-t border-zinc-200/70 p-3 dark:border-white/[0.06]">
                  ...
                  <div className="mt-2 flex items-center gap-1 rounded-md border border-zinc-200/70 bg-white px-2 dark:border-white/[0.07] dark:bg-black/40">
                    ...
                    <input
                      ...
                      className="flex-1 bg-transparent py-1.5 font-mono text-[13.5px] text-zinc-800 outline-none placeholder:text-zinc-400 dark:text-zinc-200"
                    />
                  </div>
                  <div className="flex items-start gap-1.5 rounded-md border border-indigo-300/40 bg-indigo-50/60 px-2 py-1.5 dark:border-indigo-400/20 dark:bg-indigo-400/[0.06]">
                    ...
                    <span className="font-mono text-[12.5px] leading-snug text-indigo-700 dark:text-indigo-200">
                      Commands entered here are intercepted and handled by the Orchestrator.
                    </span>
                  </div>

                  {onOpenProcesses && (
                    <div className="mt-4 pt-3 border-t border-zinc-200/70 dark:border-white/[0.06]">
                      <button
                        onClick={onOpenProcesses}
                        className="flex w-full items-center gap-2 rounded-md border border-zinc-200/70 bg-white px-3 py-2 text-zinc-700 transition hover:bg-zinc-50 dark:border-white/[0.08] dark:bg-white/[0.03] dark:text-zinc-300 dark:hover:bg-white/[0.06]"
                      >
                        <Activity className="h-4 w-4 text-indigo-500" />
                        <span className="text-[14px] font-medium">Watch Processes</span>
                      </button>
                    </div>
                  )}
                </div>
      ...
      <div className="border-t border-zinc-200/70 px-3 py-3 pb-32 dark:border-white/[0.06]">
        <div className="rounded-lg border border-emerald-300/40 bg-emerald-50 px-3 py-2 dark:border-emerald-400/15 dark:bg-emerald-400/[0.04]">
          <div className="flex items-center gap-1.5">
            ...
            <span className="text-[14px] text-zinc-900 dark:text-white">Backend healthy</span>
          </div>
          <div className="mt-1 font-mono text-[12px] text-zinc-500 dark:text-zinc-400">
...
function GitField({
  ...
  return (
    <div className="flex items-center gap-2">
      <span className="w-12 shrink-0 font-mono text-[12px] uppercase tracking-[0.18em] text-zinc-500 dark:text-zinc-400">
        {label}
      </span>
      <span
        className={`flex-1 ${truncate ? "truncate" : ""} ${mono ? "font-mono" : ""} text-[14px] ${
