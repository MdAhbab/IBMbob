      ...
      {!collapsed && (
        <>
          <div className="flex items-center gap-1 border-b border-zinc-200/70 px-3 py-2 dark:border-white/[0.06]">
            ...
            <button className="ml-auto flex items-center gap-1 text-[13px] text-zinc-500 hover:text-zinc-700 dark:hover:text-zinc-200">
          ...
          >
            ...
            <div className="text-[15px] text-zinc-700 dark:text-zinc-300">Drop context files</div>
                ...
                >
                  ...
                  <div className="min-w-0 flex-1">
                    <div className="flex items-center gap-1.5">
                      <span className="truncate font-mono text-[14px] text-zinc-800 dark:text-zinc-200">
                        {f.name}
                      </span>
                      {f.pinned && <Lock className="h-2.5 w-2.5 text-zinc-400" />}
                      <span className="font-mono text-[12px] text-zinc-500">{f.size}</span>
                    </div>
                    <div className="mt-0.5 flex items-center gap-1.5">
                      ...
                      {f.status === "syncing" && (
                        <>
                          ...
                          <span className="font-mono text-[12px] text-amber-600 dark:text-amber-300">
                            propagating…
                          </span>
                        </>
                      )}
                      {f.status === "stale" && (
                        <>
                          ...
                          <span className="font-mono text-[12px] text-rose-600 dark:text-rose-300">
                            stale · resync
                          </span>
                        </>
                      )}
                      {f.source === "orchestrator" && (
                        <span className="ml-auto rounded border border-indigo-200/70 bg-white/60 px-1 font-mono text-[11px] uppercase tracking-wider text-indigo-700 dark:border-indigo-400/20 dark:bg-indigo-400/10 dark:text-indigo-300">
                          auto
                        </span>
                      )}
                    </div>
