          ...
          >
            <div className="flex items-center justify-between border-b border-zinc-200/70 px-4 py-2.5 dark:border-white/[0.06]">
              <div className="flex items-center gap-2">
                ...
                <span className="font-mono text-[13px] uppercase tracking-[0.22em] text-rose-600 dark:text-rose-400">
                  recording
                </span>
              ...
              <button
                onClick={stop}
                className="rounded-md border border-zinc-200/70 bg-white px-2 py-1 text-[14px] text-zinc-700 hover:bg-zinc-50 dark:border-white/[0.07] dark:bg-white/[0.02] dark:text-zinc-300"
              >
            ...
            <div className="border-t border-zinc-200/70 px-4 py-3 dark:border-white/[0.06]">
              ...
              <div className="mt-1 min-h-[24px] text-[16px] text-zinc-900 dark:text-zinc-100">
                {partial || (
            ...
            <div className="flex items-center justify-end gap-2 border-t border-zinc-200/70 bg-zinc-50/60 px-4 py-2 dark:border-white/[0.06] dark:bg-black/30">
              <button
                ...
                className="rounded-md bg-zinc-900 px-3 py-1.5 text-[14.5px] text-white hover:bg-zinc-800 disabled:opacity-40 dark:bg-white dark:text-zinc-900"
              >
                Send transcript
              </button>
            </div>
