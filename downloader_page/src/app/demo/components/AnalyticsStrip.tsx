  ...
  return (
    <div className="overflow-hidden rounded-xl border border-zinc-200/70 bg-white/60 px-4 py-3 backdrop-blur dark:border-white/[0.07] dark:bg-zinc-950/40">
      <div className="flex items-start justify-between">
        <div>
          <div className={`font-mono text-[12.5px] uppercase tracking-[0.22em] ${labelColor || "text-zinc-500"}`}>
            {label}
          </div>
          <div className="mt-1.5 text-[23px] tracking-tight text-zinc-900 dark:text-white">
            {value}
          </div>
          <div className="font-mono text-[13px] text-zinc-500">{sub}</div>
        </div>
