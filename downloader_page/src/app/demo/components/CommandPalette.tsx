          ...
          >
            <div className="flex items-center gap-2 border-b border-zinc-200 px-4 dark:border-white/[0.06]">
              ...
              <input
                ...
                className="flex-1 bg-transparent py-3 text-[16.5px] text-zinc-900 outline-none placeholder:text-zinc-400 dark:text-zinc-100"
              />
              <kbd className="rounded-md border border-zinc-200 bg-zinc-50 px-1.5 py-0.5 font-mono text-[12.5px] text-zinc-500 dark:border-white/10 dark:bg-white/[0.04]">
                esc
              </kbd>
            </div>
            <div className="max-h-[60vh] overflow-y-auto p-2 scrollbar-thin">
              {Object.entries(groups).map(([g, items]) => (
                <div key={g} className="mb-1">
                  <div className="px-2 py-1 font-mono text-[12px] uppercase tracking-[0.22em] text-zinc-400">
                    {g}
                  </div>
                  {items.map((c) => (
                    <button
                      ...
                      className="flex w-full items-center gap-2.5 rounded-md px-2 py-2 text-left text-[16px] text-zinc-800 transition hover:bg-zinc-100 dark:text-zinc-200 dark:hover:bg-white/[0.05]"
                    >
                      <c.icon className="h-3.5 w-3.5 text-zinc-500" />
                      <span className="flex-1">{c.label}</span>
                      {c.hint && (
                        <kbd className="rounded border border-zinc-200 bg-zinc-50 px-1.5 py-0.5 font-mono text-[12.5px] text-zinc-500 dark:border-white/10 dark:bg-white/[0.04]">
                          {c.hint}
                        </kbd>
                      )}
