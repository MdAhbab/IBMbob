  ...
  return (
    <div className={`relative ${className}`}>
      <button
        ...
        type="button"
        onClick={() => setOpen((o) => !o)}
        className={`flex w-full items-center justify-between gap-2 rounded-md border border-zinc-200/70 bg-white/60 px-2.5 py-1.5 text-[14px] text-zinc-700 transition hover:bg-white dark:border-white/[0.07] dark:bg-white/[0.02] dark:text-zinc-300 dark:hover:bg-white/[0.05] ${
          mono ? "font-mono" : ""
        }`}
      >
            ...
            >
              {options.map((o) => (
                <button
                  ...
                  className={`flex w-full items-center justify-between rounded px-2 py-1.5 text-[14px] transition hover:bg-zinc-100 dark:hover:bg-white/5 ${
                    mono ? "font-mono" : ""
